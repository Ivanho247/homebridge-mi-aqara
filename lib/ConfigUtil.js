class ConfigUtil {
    ...
    getDisableVirtualButtons() {
        if (this.config['disable_virtual_buttons']) {
            return this.config['disable_virtual_buttons']
        } else {
            return false
        }
    }

    getDisableVirtualJoinPermissionButton() {
        if (this.config['disable_join_permission']) {
            return this.config['disable_join_permission']
        } else {
            return false
        }
    }
